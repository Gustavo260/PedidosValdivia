...
<!-- Fin encabezado --> 
	...
	<section>
	<center><h1>Mis Últimos Pedidos Confirmados</h1></center><br>
    <div class="caja">
    ...
    <br>
    <br>
     <center><a class="envio" href="testestilos2.php?txtRestaurante=<?php echo $_GET['txtRestaurante']; ?>">Volver</a></center>
	</section>
</body>
